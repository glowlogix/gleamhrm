    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        @if(Auth::user()->isAllowed('ApplicantController:index') && Auth::user()->isAllowed('JobsController:index'))
          <li class="nav-item">
            <a href="#" class="nav-link" @if(request()->is('applicants/hired') || request()->is('job') || request()->is('applicant') || request()->is('job/create')) class="nav-link active" @else class="nav-link" @endif>
            ...
            <ul class="nav nav-treeview">
              @if(Auth::user()->isAllowed('ApplicantController:index'))
                <li class="nav-item">
                  <a href="{{route('applicants')}}" class="nav-link" @if(request()->is('applicants/hired')) class="nav-link active" @else class="nav-link" @endif>
              ...
              @if(Auth::user()->isAllowed('JobsController:index'))
                <li class="nav-item">
                  <a href="{{route('job.index')}}" @if(request()->is('job/create'))  class="nav-link active" @else class="nav-link" @endif>
                    <i class="far fa-circle nav-icon"></i>
                    <p>Jobs</p>
                  </a>
                </li>
        ...
        @if(Auth::user()->isAllowed('EmployeeController:index') || Auth::user()->isAllowed('OrganizationHierarchyController:index') || Auth::user()->isAllowed('TeamController:index') || Auth::user()->isAllowed('VendorController:index'))
          <li class="nav-item">
            <a href="#" @if( request()->is('employees')  || request()->is('teams') || request()->is('vendors') || request()->is('vendor/create')  || str_contains( Request::fullUrl(),'organization_hierarchy') || request()->is('employee/create') || str_contains(Request::fullUrl(),'employee/edit') || str_contains(Request::fullUrl(),'team_member')) class="nav-link active" @else class="nav-link" @endif>
            ...
            <ul class="nav nav-treeview">
              @if(Auth::user()->isAllowed('EmployeeController:index'))
                <li class="nav-item">
                  <a href="{{route('employees')}}" @if(request()->is('employee/create') || str_contains(Request::fullUrl(),'employee/edit')) class="nav-link active" @else class="nav-link" @endif>
                    <i class="far fa-circle nav-icon"></i>
                    <p>Employees</p>
                  </a>
                </li>
              ...
              @if(Auth::user()->isAllowed('VendorController:index'))
                <li class="nav-item">
                  <a href="{{route('vendors.index')}}" @if(request()->is('vendor/create')) class="nav-link active" @else class="nav-link" @endif>
                    <i class="far fa-circle nav-icon"></i>
                    <p>Vendors</p>
                  </a>
                </li>
        ...
        @endif
        <li class="nav-item">
          <a href="#" @if(str_contains(Request::fullUrl(),'attendance') || request()->is('leave/create') || request()->is('leave/admin_create') || request()->is('my_leaves') || request()->is('employee_leaves') || str_contains(Request::fullUrl(),'leave/edit')|| str_contains(Request::fullUrl(),'leave/show')) class="nav-link active" @else class="nav-link" @endif>
          ...
          <ul class="nav nav-treeview">
            @if(Auth::user()->isAllowed('AttendanceController:today_timeline'))
              <li class="nav-item">
                <a href="{{route('today_timeline')}}" @if( str_contains(Request::fullUrl(),'attendance/create')) class="nav-link active" @else class="nav-link" @endif>
                  <i class="far fa-circle nav-icon"></i>
                  <p>Today</p>
                </a>
              </li>
            ...
            @if(Auth::user()->isAllowed('LeaveController:employeeleaves'))
              <li class="nav-item">
                <a href="{{route('employeeleaves')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Leaves</p>
                </a>
              </li>
            @endif
            <li class="nav-item">
              <a href="{{route('leave.index')}}" @if(request()->is('leave/create') || str_contains(Request::fullUrl(),'leave/edit') || str_contains(Request::fullUrl(),'leave/show')) class="nav-link active" @else class="nav-link" @endif>
                <i class="far fa-circle nav-icon"></i>
                <p>My Leaves</p>
              </a>
            </li>
        ...
        <li class="nav-item">
          <a href="#" @if(request()->is('rolespermissions/create') ||request()->is('rolespermissions')) class="nav-link active" @else class="nav-link" @endif>
          ...
          <ul class="nav nav-treeview">
            @if(Auth::user()->isAllowed('RolePermissionsController:index'))
              <li class="nav-item">
                <a href="{{route('roles_permissions')}}" @if(request()->is('rolespermissions/create'))class="nav-link active" @else class="nav-link" @endif>
                  <i class="far fa-circle nav-icon"></i>
