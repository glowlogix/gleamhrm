                        ...
                        <table id="demo-foo-accordion" class="table table-bordered m-b-0 table-hover toggle-arrow-tiny" data-filtering="true" data-paging="true" data-sorting="true" data-paging-size="7">
                            ...
                            @if(count($employees) > 0) @foreach($employees as $employee)
                                <tr>
                                    ...
                                    <td>isset($employee->attendanceSummary) ? $employee->attendanceSummary->first_time_in : ''</td>
                                    <td>isset($employee->attendanceSummary) ? $employee->attendanceSummary->last_time_out : ''</td>
                                    <td class="text-nowrap">
                                        <a class="btn btn-info btn-sm"  data-toggle="modal" data-target="#popup{{ $employee->id }}"> <i class="fas fa-window-close text-white"></i></a>
                                        {{--///Dialog Box/// --}}
                                                            ...
                                                            <div class="container-fluid">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="input-group date1">
                                                                        ...
                                                                        <input class="form-control" name="date" value="{{Carbon\Carbon::now()->format('h:i a')}}" />
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="input-group timepicker">
                                                                        <input class="form-control" name="time_in" value="{{Carbon\Carbon::now()->format('h:i a')}}" />
                                                                        <span class="input-group-addon">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="input-group timepicker">
                                                                        <input class="form-control" name="time_out" value="{{Carbon\Carbon::now()->format('h:i a')}}" />
                                                                        <span class="input-group-addon">
                                                                            <i class="fa fa-clock-o" style="font-size:16px"></i>
                                                                        </span>
                                                                    </div>
