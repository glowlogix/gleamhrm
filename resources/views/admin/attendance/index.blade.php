    ...
    <div class="panel panel-default">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(){
                ...
                //         var datepick = $('input[name="datepick"]').val();
                //         var delay = $('input[name="delay"]').val();
                //         if (document.getElementById("Checkbox").checked == true) 
                //         {
                //            var checkintime = $('input[name="timepick"]').val();
                //            var checkouttime =$('input[name="timepick"]').val(null);
                //         }
                //         else 
                //         {
                //             var checkouttime = $('input[name="timepick"]').val();
                //             var checkintaime = $('input[name="timepick"]').val(null);
                //         }
                //         var data ="abc";
