                ...
                <div class="panel-body">
                    ...
                    <form class="form-inline" action="{{route('employee.profile.update',['id'=>$d->id])}}" method="post">
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <input style="width: 250px;" type="text" placeholder="Please enter firstname" name="firstname" value="{{$d->firstname}}"
                                class="form-control">
                        </div>
                        <div class="form-group col-sm-4">
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <input style="width: 250px;" type="text" placeholder="Please enter Emergency Contact" name="emergency_contact" value="{{$d->emergency_contact}}"
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <input style="width: 250px;" type="text" placeholder="Please enter Emergency Relationship" name="emergency_contact_relationship"
                                value="{{$d->emergency_contact_relationship}}" class="form-control">
                        </div>
                        <div class="form-group col-sm-4">
