                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-inline" action="{{route('employee.profile.update',['id'=>$d->id])}}" method="post">
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <input style="width: 250px;" type="text" placeholder="Please enter firstname" name="firstname" value="{{$d->firstname}}" class="form-control">
                                    </div>
                                    <div class="form-group col-sm-4">
                                        <label for="lname">Lastname</label>
                                        <input style="width: 250px;" type="text" placeholder="Please enter lastname" name="lastname" value="{{$d->lastname}}" class="form-control">
                                    </div>
                                    <div class="form-group col-sm-4">
                                        <label for="contact">Contact</label>
                                        @if($d->contact)
                                        <input style="width: 250px;" type="text" name="contact" placeholder="Please enter contact" value="{{$d->contact}}" class="form-control"> @else
                                    ...
                                    <div class="form-group col-sm-4">
                                            ...
                                            <input style="width: 250px;" type="text" placeholder="Please enter Emergency Contact"  name="emergency_contact" value="{{$d->emergency_contact}}" class="form-control"> @else
                                    ...
                                    <div class="form-group col-sm-4">
                                            ...
                                            <input style="width: 250px;" type="text" placeholder="Please enter Emergency Relationship"  name="emergency_contact_relationship" value="{{$d->emergency_contact_relationship}}" class="form-control">
                                    </div>
                                    <div class="form-group col-sm-4">
                                        <label for="password">Password</label>
                                        <input style="width: 250px;" type="password" name="password" placeholder="Enter Your New Password" value="{{$d->password}}" class="form-control">
                                    </div>
