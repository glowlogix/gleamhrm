    ...
    <div class="panel-heading text-center">
        ...
        <span style="float: right;">
            <a href="{{route('employees')}}" class="btn btn-info btn-xs" align="right">
                <span class="glyphicon"></span>Back</a>
        </span>
    </div>
    <div class="panel-body">
        <form class="form-inline" action="{{route('employee.store')}}" method="post">
            ...
            <div class="form-group col-sm-4">
                ...
                <input style="width: 250px;" type="Number" class="form-control" id="contact_no" placeholder="Enter Contact Number" name="contact_no" value="{{ old('contact_no') }}" pattern="[0-9]{11}" required>
            </div>
            <div class="form-group col-sm-4">
                <br>
            ...
            <div class="form-group col-sm-4">
                ...
                <input style="width: 250px;" type="text" class="form-control" id="cnic" placeholder="Enter Emergency Contact Relationship" name="cnic" value="{{ old('cnic') }}" pattern="[0-9]{13}">
            </div>
            <div class="form-group col-sm-4">
                <br>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text"  class="form-control " id="date_of_birth" placeholder="1988-12-23" name="date_of_birth"  required>
                                    </div>
                                </div>
                            </div>
